...
{
    _tittleView = [self setTittleViewStyle];
    [self setTittleViewWithPickViewFrame];
    [self addSubview:_tittleView];
}

-(UIView *)setTittleViewStyle
{
    ...
    CGFloat btn1H = 40;
   // CGFloat margin = 100;
   // CGFloat btn1X = (WIDTH - 2*btn1W - margin)/2;
    CGFloat btn1X = 100;
    CGFloat btn2X = WIDTH - btn1X - btn1W;
    CGFloat btn1Y = 0;
    
    UIButton *btn1 = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn1 setTitle:@"取消" forState:UIControlStateNormal];
    [btn1 setTitleColor:[UIColor lightGreenColor] forState:UIControlStateNormal];
    [btn1 addTarget:self action:@selector(remove) forControlEvents:UIControlEventTouchUpInside];
    [btn1 setFrame:CGRectMake(btn1X, btn1Y, btn1W, btn1H)];
    UIButton *btn2 = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn2 setTitleColor:[UIColor lightGreenColor] forState:UIControlStateNormal];
    [btn2 setTitle:@"确定" forState:UIControlStateNormal];
    [btn2 addTarget:self action:@selector(doneClick) forControlEvents:UIControlEventTouchUpInside];
    [btn2 setFrame:CGRectMake(btn2X,btn1Y, btn1W, btn1H)];
...
//    toolbar.items=@[lefttem,centerSpace,right];
    ...
    [btn1 setTitle:@"取消" forState:UIControlStateNormal];
    [btn1 addTarget:self action:@selector(remove) forControlEvents:UIControlEventTouchUpInside];
    [btn1 setFrame:CGRectMake(50, 0, 60, 30)];
    ...
    [btn2 setFrame:CGRectMake(0, 0, 60, 30)];
    UIBarButtonItem *item2 = [[UIBarButtonItem alloc]initWithCustomView:btn2];
    toolbar.items=@[item1,centerSpace,item2];
    return toolbar;
}
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width - 0, ZHToobarHeight);
}

-(void)setTittleViewWithPickViewFrame
{
    _tittleView.frame = CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width - 0, ZHToobarHeight);
}
...
-(void)setTintColor:(UIColor *)color{
    ...
    _toolbar.tintColor=[UIColor lightGreenColor];
}
/**
 *  设置toobar的背景颜色
 */
